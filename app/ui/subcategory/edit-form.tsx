...
import { FormattedCategoriesTable, Subcategory } from '@/app/lib/definitions';
...
export default function Form({
  ...
  const [state, dispatch] = useFormState(updateSubcategoryWithId, initialState);
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={subcategory.t_name}
              />
            </div>
          </div>
